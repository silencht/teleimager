...
4. Configure Certificate Paths (Choose One Method)
    ...
    The certificate used for WebRTC transport in this repo is normally generated by the [televuer](https://github.com/silencht/televuer) repository (the same cert is reused by the **vuer** http server).
